...
class HacksawController extends Controller
{
    public function index()
    {
        ...
        // Menggunakan DB::table('fiver_games') agar sesuai dengan struktur database lu
        // Pastikan 'FUNGAMING' adalah nilai yang tersimpan di kolom 'game_provider' lu
        $gamelist = DB::table('fiver_games')
                        ->where('game_provider', 'HACKSAW') 
