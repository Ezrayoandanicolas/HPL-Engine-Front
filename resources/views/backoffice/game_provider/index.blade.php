            ...
            <div class="card card-outline" style="border-top: 3px solid #6f42c1;">
                ...
                <div class="card-body">
                    ...
                    <div class="alert d-flex align-items-center justify-content-between flex-wrap"
                         style="background:{{ $current === 'dc' ? 'linear-gradient(135deg,#7c3aed,#a855f7)' : 'linear-gradient(135deg,#0ea5e9,#06b6d4)' }};border:none;border-radius:12px;color:#fff;">
                        <div>
                            ...
                            <div class="font-weight-bold" style="font-size:22px;">
                                <i class="fas {{ $current === 'dc' ? 'fa-crown' : 'fa-server' }} mr-2"></i>{{ $label }}
                            </div>
                        </div>
                        <div class="text-right">
                            ...
                            <div class="font-weight-bold" style="font-size:20px;">
                                Rp {{ number_format(($current === 'dc' ? ($balances['dcBalance'] ?? 0) : ($balances['agentBalance'] ?? 0)), 0, ',', '.') }}
                            </div>
                        </div>
                    </div>
