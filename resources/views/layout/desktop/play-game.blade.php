...
@section('content')
    ...
    {{-- Ubah $gamelist as $gamelist menjadi $gamelist as $game --}}
    @foreach ($gamelist as $game)
        <div class="game-item" data-game="{{ $game->game_name }}" data-match="true"
            id="game_list">
            <div class="wrapper-container">
                
                {{-- KASIH FALLBACK GAMBAR DISINI (Ganti link gambar defaultnya sesuai yg lu punya) --}}
                <img
                    src="{{ !empty($game->image_url)
                            ? $game->image_url
                            : (!empty($game->game_image)
                                ? $game->game_image
                                : asset('assets/images/default-game.png')) }}"
                    alt="{{ $game->game_name }}"
                ...
                @if($title == 'SPORTS')
                    ...
                    <a class="play-now"
                        href="{{ route('sports.play', $game->game_uid) }}">
                        MAIN
                    </a>

                @elseif(request()->is('casino/*'))

                    <a class="play-now"
                        href="{{ route('casino.play', $game->game_uid) }}">
                        MAIN
                    </a>
